...
SECRET_KEY = 'django-insecure-*047&pzd@8)whgjcs=!&u#9lm1mnna3mw^g1ht^sy_#=a%$$+m'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'), os.path.join(BASE_DIR, 'getting_started', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
